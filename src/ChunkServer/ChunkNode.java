...
public class ChunkNode implements Node {
   ...
   private Hashtable<String, String> chunkServerFileIntegretyCheckSumCollection =
         new Hashtable<String, String>();
   private Hashtable<String, Integer> fileSpiltInfoInfoCollection =
   ...
   public void sendtheChunkNodeinfotoController() throws Exception {
      ...
      Command resp = sender.sendAndReceiveData(this.controllerNodeIP, this.controllerNodePORT,
            livereq.unpack());
   ...
   public void sendchunkkinfoToCOntroller() throws NoSuchAlgorithmException, IOException {
      ...
      ChunkNodeFileInfoCommand cmd = new ChunkNodeFileInfoCommand("", 0, this.chunkNodeIP,
       ...
       * this.controllerNodePORT, this.chunkNodeIP, this.chunkrNodePORT,null , temperU.checkSumID);
       * 
       * 
       */
